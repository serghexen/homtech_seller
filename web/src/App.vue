...
.plan-badge { position: relative; display: flex; min-width: 105px; min-height: 46px; align-items: center; gap: 10px; padding: 7px 14px 7px 11px; overflow: hidden; border: 1px solid rgba(112,143,238,.34); border-radius: 14px; color: #d8e2ff; background: linear-gradient(135deg,rgba(30,51,112,.66),rgba(18,28,58,.82)); box-shadow: inset 0 1px rgba(255,255,255,.035); }
...
.plan-badge__copy strong { color: currentColor; font-size: 14px; font-weight: 800; letter-spacing: -.01em; }
.profile-button, .seller-nav__item, .secondary-button { border: 1px solid rgba(149,164,203,.28); border-radius: 14px; color: #dce5f9; background: rgba(31,40,70,.72); font-weight: 750; } .profile-button { display: inline-flex; align-items: center; gap: 4px; padding: 11px 15px; font-size: 13px; }
